/*
* @Author: huoqishi
* @Date:   2016-07-10 16:04:33
* @Last Modified by:   huoqishi
* @Last Modified time: 2016-07-10 17:29:11
*/
...
(function(angular){
  ...
  // 2.创建商品列表服务
  app.factory('goodsListService',function(
    $q // 在angular里用来进行promise操作
    ){
    return {
       getDataList:function(typeNumber){
        ...
        // return obj_goodsListData;
         var deffered = $q.defer();// 得到一个延迟对象
         deffered.resolve(obj_goodsListData);// defered有个resovle方法，类似于promise中的resolve方法
